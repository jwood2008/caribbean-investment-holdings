...
export function Contact() {
  return (
    <section id="contact" className="section-paper py-24 md:py-32">
        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-12 lg:gap-20 items-start">
          <Reveal>
            ...
            <h2 className="display mt-8 text-[40px] md:text-[60px] leading-[0.98] max-w-[14ch]">
              A short
              <br />
              <span className="italic text-accent">conversation</span> first.
            </h2>
            <p className="mt-8 text-[16px] leading-[1.65] text-paper-foreground/70 max-w-[48ch]">
              ...
              offices, and operating partners. Reach out — we&apos;ll set up a
              call before pointing you to TierraDex for accreditation and
              subscription.
            </p>
          </Reveal>

          <Reveal delay={1} className="rounded-[28px] border border-[color:var(--rule)] bg-[color:var(--muted)]/50 p-8 md:p-12">
